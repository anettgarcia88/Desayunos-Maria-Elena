                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-6 d-flex flex-column align-items-center justify-content-center">
                            <div class="card-body p-4 p-md-5 mx-md-4">
                                <div class="text-center mb-4">
                                    <img src="<?php echo e(asset('assets/user.png')); ?>" class="img-fluid" style="width: 150px;" alt="logo">
                                </div>
                                <form action="<?php echo e(route('register')); ?>" method="post">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-danger">Iniciar Sesión</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 d-flex align-items-center gradient-custom-2 justify-content-center">
                            <div class="text-white text-center px-4 py-4">
                                <img src="<?php echo e(asset('assets/logo1.png')); ?>" class="img-fluid" style="max-width: 80%;" alt="logo">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\59172\Downloads\Proyecto de Web II Final (1)\crudProductos\apis_elena\resources\views/auth/register.blade.php ENDPATH**/ ?>