...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <a class="navbar-brand" href="#">
      <img src="{{ asset('imgs/logo3.png') }}" alt="Logo" class="logo" style="height: 50px;">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
          ...
          <a class="nav-link" href="{{ route('carrito') }}">
            <img src="{{ asset('imgs/carrito.png') }}" alt="Carrito" class="carrito" style="height: 35px;">
          </a>
           </li> -->
...
<div class="d-flex justify-content-center align-items-center">
    <img src="{{ asset('imgs/maices.gif') }}" class="img-fluid rounded-5" alt="maices">
</div>
 <br>
    ...
    <div class="about-section row d-flex justify-content-center align-items-center">
        ...
        <div class="image col-md-6 d-flex justify-content-center">
            <img class="img-fluid rounded-3" src="{{ asset('imgs/apipastel.png') }}" alt="Desayuno">
        </div>
    </div>
    </div>
    ...
    <img src="{{ asset('imgs/logo3.png') }}" alt="Desayunos Maria Elena" class="infoimg img-fluid">
     </div>
...
<div class="floating-cart">
    <a  href="{{ route('carrito') }}">
      <img src="{{ asset('imgs/carrito.png') }}" alt="Carrito">
    </a>
  </div>
